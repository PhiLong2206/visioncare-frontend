...
import PreOrderDetail from "./pages/StaffPages/PreOrdersManagement/PreOrderDetail";
...
import PreOrderPaymentResult from "./pages/CustomerPages/PreOrderPaymentResult";
import PaymentSimulation from "./pages/CustomerPages/PaymentSimulation";
import MyPreOrders from "./pages/CustomerPages/MyPreOrders";
  ...
  return (
    <div className="min-h-screen bg-[#f6f7f9]">
      ...
      <Routes>
        ...
        <Route path="/payment/success" element={<PreOrderPaymentResult />} />
        <Route
          path="/payment/cancel"
          element={<PreOrderPaymentResult cancelled />}
        />

        <Route path="/staff" element={<StaffPage />} />
        <Route path="/staff/orders/:id" element={<StaffOrderDetail />} />
        <Route path="/staff/pre-orders/:id" element={<PreOrderDetail />} />
