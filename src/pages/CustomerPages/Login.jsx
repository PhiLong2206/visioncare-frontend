...
function Login() {
  ...
  const getRoleId = (authUser) => {
    ...
    if (!Number.isNaN(roleId)) return roleId;

    // Nếu rawRole là string (tên role), map qua ID
    if (typeof rawRole === "string" && ROLE_NAMES_MAP[rawRole]) {
      return ROLE_NAMES_MAP[rawRole];
    }
