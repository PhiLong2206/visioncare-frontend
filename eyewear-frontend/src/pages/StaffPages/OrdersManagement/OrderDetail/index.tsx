      ...
      <header className="flex justify-between items-center mb-6">
        <div>
          <div className="flex items-center gap-2 text-sm text-slate-500 mb-1">
            <Link to="/staff">Orders</Link> <ChevronRight size={14} /> <span>Order #{id || 'VC-88291'}</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900">Review Prescription</h1>
        </div>
        <div className="flex gap-3">
          <button className="px-4 py-2 bg-teal-700 text-white rounded-md font-medium flex items-center gap-2 hover:bg-teal-800 transition-colors">
            Confirm & Send to Operations <Send size={18} />
          </button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-3 space-y-6">
          ...
          <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            ...
            <p className="text-sm text-slate-500 mb-6">Patient ID: #PS-4492-B</p>
          ...
          <section className="bg-slate-50/50 rounded-xl border border-slate-200 p-5">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-slate-500">Lens Material</span>
                <span className="font-semibold">1.67 High-Index Clear</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Coatings</span>
        ...
        <div className="col-span-12 lg:col-span-9 space-y-6 relative">
          ...
          <button className="absolute -right-2 top-1/2 bg-teal-800 text-white p-3 rounded-xl shadow-lg z-10 hover:scale-105 transition-transform">
            <Plus size={24} />
          </button>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h2 className="text-xl font-bold">Extracted Prescription Data</h2>
                <p className="text-sm text-slate-500">Verify automated OCR results against original scan.</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-6 gap-4 items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] font-bold text-teal-700 uppercase">Right Eye</span>
                </div>
              ...
              <div className="grid grid-cols-6 gap-4 items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] font-bold text-teal-600 uppercase">Left Eye</span>
                </div>
                <input type="text" defaultValue="-2.25" className="bg-white border border-slate-200 rounded-md p-3 text-center font-bold" />
            ...
            <div className="grid grid-cols-12 gap-8 mt-8">
              <div className="col-span-6">
                <h4 className="text-sm font-bold mb-4">Pupillary Distance (PD)</h4>
                <div className="flex gap-4">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex-1">
                    <span className="text-[10px] font-bold text-slate-400 block mb-2 uppercase">Monocular PD (R/L)</span>
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex-1">
                    <span className="text-[10px] font-bold text-slate-400 block mb-2 uppercase">Binocular PD</span>
              ...
              <div className="col-span-6">
                <h4 className="text-sm font-bold mb-4">Clinical Observations</h4>
                <textarea 
                  placeholder="Enter clinical notes for operations team..." 
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold">OCR Match Score: 98%</div>
                <div className="text-[10px] text-slate-400">Validated against VisionLink DB</div>
              </div>
            </div>
            <div className="flex gap-4">
