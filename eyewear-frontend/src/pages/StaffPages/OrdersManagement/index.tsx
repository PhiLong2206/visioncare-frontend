          ...
          <tbody>
            {paginated.length === 0 ? (
              ...
              paginated.map((order, i) => (
                <tr
                  key={order.id}
                  className={`border-b border-gray-50 hover:bg-gray-50 transition-colors ${i === paginated.length - 1 ? "border-b-0" : ""}`}
                >
                  <td className="px-5 py-4">
                    <button className="text-teal-500 font-semibold text-sm hover:text-teal-700 hover:underline">#{order.id}</button>
                  </td>
                  <td className="px-5 py-4">
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="text-red-400 hover:text-red-500 transition-colors" title="Delete">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
