                ...
                <header className="bg-white border-b border-gray-200 px-6 flex items-center justify-end h-12 shrink-0">
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Global Search..." className="pl-8 pr-3 py-1.5 text-xs bg-gray-50 border border-gray-200 rounded-lg w-48 focus:outline-none focus:ring-1 focus:ring-teal-400" />
                        </div>
